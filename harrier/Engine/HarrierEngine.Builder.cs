...
public sealed partial class HarrierEngine
{
    /// <summary>
    /// Factory for configuring and constructing an <see cref="HarrierEngine"/>.
    /// Usage:
    /// <code>
    /// var engine = HarrierEngine.CreateBuilder()
    ///     .SetPort(8080)
    ///     .SetBacklog(16384)
    ...
    /// </code>
    /// </summary>
    public static HarrierBuilder CreateBuilder() => new HarrierBuilder();
    ...
    private HarrierEngine() { }
    
    /// <summary>
    /// Fluent builder for <see cref="HarrierEngine"/>. This configures static fields,
    /// then <see cref="Build"/> finalizes OS resources (listen socket) and decides worker count.
    /// </summary>
    public sealed class HarrierBuilder
    {
        private readonly HarrierEngine _engine;
        public HarrierBuilder() => _engine = new HarrierEngine();

        /// <summary>Set the TCP listening port (default: 8080).</summary>
        public HarrierBuilder SetPort(int port)
        {
            _port = port;
            return this;
        }
        ...
        /// </summary>
        public HarrierBuilder SetBacklog(int backlog)
        {
            _backlog = backlog;
            return this;
        }
        ...
        /// </summary>
        public HarrierBuilder SetMaxNumberConnectionsPerWorker(int maxNumberConnectionsPerWorker)
        {
        ...
        /// </summary>
        public HarrierBuilder SetSlabSizes(int inSlabSize, int outSlabSize)
        {
        ...
        /// </summary>
        public HarrierBuilder SetMaxEventsPerWake(int maxEventsPerWake)
        {
        ...
        /// </summary>
        public HarrierBuilder SetMaxStackSizePerThread(int maxStackSizePerThread)
        {
        ...
        /// </summary>
        public HarrierBuilder SetNWorkersSolver(Func<int>? solver)
        {
        ...
        /// </summary>
        public HarrierBuilder InjectHandler(Func<Connection, Task> handler)
        {
            _sHandler = handler;
            return this;
        }
