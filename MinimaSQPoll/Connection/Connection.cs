...
public sealed unsafe partial class Connection 
{
    ...
    // Convenience: hand a buffer back to the reactor's shared buf_ring. Lives
    // here (instead of the deleted Connection.Incremental.cs) because the raw
    // handler API in Program.cs and ConnectionPipeReader both call it.
