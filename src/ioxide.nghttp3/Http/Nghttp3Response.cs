...
/// <see cref="Nghttp3Request"/>. Header names must be ASCII (they're lowercased as they're packed);
...
/// </summary>
public sealed class Nghttp3Response
{
    ...
    /// </summary>
    public static Nghttp3Response Text(string body, int status = 200)
    {
