...
/// <see cref="Nghttp2Request"/>. Header names must be ASCII (they're lowercased as they're packed);
...
/// </summary>
public sealed class Nghttp2Response
{
    ...
    /// </summary>
    public static Nghttp2Response Text(string body, int status = 200)
    {
        var response = new Nghttp2Response
        {
            Status = status,
